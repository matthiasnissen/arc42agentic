...
- **Vollständig-Modus:** Alle Markdown-Dateien im Sektionsordner `02-Randbedingungen/` innerhalb des Dokumentationspfads.
- **Delta-Modus:** Nur die vom Aufrufer genannten geänderten Dateien im Sektionsordner `02-Randbedingungen/` des Dokumentationspfads.
...
2. **Dateien lesen**:
   - *Vollständig-Modus*: Lies alle Dateien im Sektionsordner `02-Randbedingungen/` des Dokumentationspfads
